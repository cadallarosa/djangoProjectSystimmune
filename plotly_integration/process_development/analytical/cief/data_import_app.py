...
app = DjangoDash('cIEFImportManagerApp', external_stylesheets=[dbc.themes.BOOTSTRAP])

# Layout
app.layout = html.Div([
    html.H2("cIEF Import Manager", style={"textAlign": "center", "marginBottom": "20px"}),

    html.Div([
        html.Label("Incoming Folder (.asc files):"),
        dcc.Input(id="incoming-folder", type="text", value="S:\Shared\Chris Dallarosa\cIEF\Imports", style={"width": "100%"}),

        html.Label("Processed Folder (move after import):", style={"marginTop": "15px"}),
        dcc.Input(id="processed-folder", type="text", value="S:\Shared\Chris Dallarosa\cIEF\Imported", style={"width": "100%"}),
